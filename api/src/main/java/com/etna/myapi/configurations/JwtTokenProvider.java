...
public class JwtTokenProvider {
    ...
    private String secretKey = "tokenamneos";
    ...
    public Authentication getAuthentication(String token) {
        var userDetails = customUserDetails.loadUserByUsername(getUsername(token));
